...
def process_attack_command(message):
    try:
        ...
        try:
            ...
            join_button = InlineKeyboardButton(text="JOIN NOW❤️‍🔥", url="https://t.me/+sUHNz0xm_205MTBl")
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/+sUHNz0xm_205MTBl*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*JOIN @IMUBHAIH FOR HELP*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*DM @RAJOWNER90*", parse_mode='Markdown')
